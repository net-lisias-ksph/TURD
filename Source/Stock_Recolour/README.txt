...
To install, simply place the files so the TURD folder resides within the GameData directory of your KSP install. Textures Unlimited and Module Manager are not included but required for this pack to function.
